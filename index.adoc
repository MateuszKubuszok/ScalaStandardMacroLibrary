...
But I hope, that it proved to you that macros can be sane.

That we can for most common use cases we can provide some sane API.
...
It doesn't have to be Hearth, it might be some other library, but I hope that I inspired you to try.
--
